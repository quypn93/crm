...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260510163359_AddOrderShipperUserId') THEN
    ALTER TABLE "Orders" DROP CONSTRAINT "FK_Orders_Users_DesignerUserId";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260510163359_AddOrderShipperUserId') THEN
    ALTER TABLE "Orders" ADD "ShipperUserId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260510163359_AddOrderShipperUserId') THEN
    CREATE INDEX "IX_Orders_ShipperUserId" ON "Orders" ("ShipperUserId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260510163359_AddOrderShipperUserId') THEN
    ALTER TABLE "Orders" ADD CONSTRAINT "FK_Orders_Users_DesignerUserId" FOREIGN KEY ("DesignerUserId") REFERENCES "Users" ("Id") ON DELETE SET NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260510163359_AddOrderShipperUserId') THEN
    ALTER TABLE "Orders" ADD CONSTRAINT "FK_Orders_Users_ShipperUserId" FOREIGN KEY ("ShipperUserId") REFERENCES "Users" ("Id") ON DELETE SET NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260510163359_AddOrderShipperUserId') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260510163359_AddOrderShipperUserId', '9.0.1');
    END IF;
END $EF$;
COMMIT;
