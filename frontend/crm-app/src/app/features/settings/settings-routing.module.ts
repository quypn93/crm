...
import { SenderAddressesAdminComponent } from './sender-addresses-admin/sender-addresses-admin.component';
...
const routes: Routes = [
  ...
  { path: 'sender-addresses', component: SenderAddressesAdminComponent },
